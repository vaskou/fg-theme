...
class Fremediti_Guitars_Nav_Walker extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = null ) {
		...
		if ( isset( $args->fg_menu_type ) ) {
			if ( 'main' == $args->fg_menu_type ) {
				...
				$pre       = "<div class='uk-navbar-dropdown uk-drop' uk-drop='delay-hide: 100; animation: uk-animation-slide-top-small; offset: 1'>";
			}
